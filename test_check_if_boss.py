...
from game import check_if_boss


class TestCheckIfBoss(TestCase):
    def test_check_if_boss_true(self):
        ...
        character = {"X-coordinate": 23, "Y-coordinate": 1}
        expected = True
        actual = check_if_boss(board, character)
        self.assertEqual(actual, expected)

    def test_check_if_boss_false(self):
        board = {(0, 0): 'none', (1, 0): 'none', (2, 0): 'none', (3, 0): 'none', (4, 0): 'wall',
                 (5, 0): 'none', (6, 0): 'none', (7, 0): 'none', (8, 0): 'none', (9, 0): 'none',
                 (10, 0): 'none', (11, 0): 'none', (12, 0): 'wall', (13, 0): 'none',
                 (14, 0): 'none', (15, 0): 'none', (16, 0): 'none', (17, 0): 'none',
