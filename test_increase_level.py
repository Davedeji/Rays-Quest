...
class TestIncreaseLevel(TestCase):
    def test_increase_level_sufficient_XP(self):
    ...
    def test_increase_level_insufficient_XP(self):
        test_character = {'name': 'xc', 'class': 'lurker', 'level': 1, 'currentHP': 10.0,
                          'weapon': 'spear', 'currentXP': 98, 'levelUpXP': 100, 'X-coordinate': 0,
                          'Y-coordinate': 0, 'accuracy': 0.66, 'strength': 0.66,
                          'weaponMultiplier': 1,
                          'resistance': 0.66}
        expected_character = {'name': 'xc', 'class': 'lurker', 'level': 1, 'currentHP': 10.0,
                              'weapon': 'spear', 'currentXP': 98, 'levelUpXP': 100,
                              'X-coordinate': 0,
                              'Y-coordinate': 0, 'accuracy': 0.66, 'strength': 0.66,
                              'weaponMultiplier': 1,
                              'resistance': 0.66}
